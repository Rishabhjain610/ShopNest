...
const CollectionPage = () => {
  ...
  useEffect(() => {
    applyFilters();
  }, [products, category, subCategory, sortType, priceRange]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white">
      ...
      <div className={`fixed inset-y-0 left-0 z-50 w-80 bg-gradient-to-b from-gray-800 to-gray-900 backdrop-blur-xl border-r border-gray-700 transform ${showFilter ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 ease-out lg:hidden`}>
          ...
          <div className="flex-1 p-6 space-y-6 overflow-y-auto">
            ...
            <div>
              ...
              >
                ...
                <FiChevronDown className={`w-5 h-5 transition-transform duration-300 group-hover:text-blue-400 ${showCategories ? 'rotate-180' : ''}`} />
              </button>
              
              {showCategories && (
                <div className="space-y-3 pl-4 animate-in slide-in-from-top duration-200">
                  {categories.map((categoryItem, index) => (
                    <label key={index} className="flex items-center cursor-pointer group hover:bg-gray-800/30 rounded-lg p-2 transition-all">
                      <input
                        type="checkbox"
                        value={categoryItem}
                        ...
                        className="sr-only"
                      />
                      <div className={`w-5 h-5 rounded-lg border-2 mr-3 transition-all flex items-center justify-center ${
            ...
            <div>
              ...
              >
                ...
                <FiChevronDown className={`w-5 h-5 transition-transform duration-300 group-hover:text-blue-400 ${showSubCategories ? 'rotate-180' : ''}`} />
              </button>
            ...
            <div>
              ...
              >
                ...
                <FiChevronDown className={`w-5 h-5 transition-transform duration-300 group-hover:text-blue-400 ${showPrice ? 'rotate-180' : ''}`} />
              </button>
          ...
          <div className="flex-1 p-6 space-y-8 overflow-y-auto">
            ...
            <div>
              ...
              >
                ...
                <FiChevronDown className={`w-6 h-6 transition-transform duration-300 group-hover:text-blue-400 ${showCategories ? 'rotate-180' : ''}`} />
              </button>
              
              {showCategories && (
                <div className="space-y-4 pl-4 animate-in slide-in-from-top duration-200">
                  {categories.map((categoryItem, index) => (
                    <label key={index} className="flex items-center cursor-pointer group hover:bg-gray-800/30 rounded-xl p-3 transition-all">
                      <input
                        type="checkbox"
                        value={categoryItem}
                        checked={category.includes(categoryItem)}
                        ...
                        className="sr-only"
                      />
                      <div className={`w-6 h-6 rounded-xl border-2 mr-4 transition-all flex items-center justify-center ${
                        category.includes(categoryItem) 
            ...
            <div>
              ...
              >
                ...
                <FiChevronDown className={`w-6 h-6 transition-transform duration-300 group-hover:text-blue-400 ${showSubCategories ? 'rotate-180' : ''}`} />
              </button>
            ...
            <div>
              ...
              >
                ...
                <FiChevronDown className={`w-6 h-6 transition-transform duration-300 group-hover:text-blue-400 ${showPrice ? 'rotate-180' : ''}`} />
              </button>
              ...
              {showPrice && (
                <div className="space-y-6 pl-4 animate-in slide-in-from-top duration-200">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm text-gray-400 mb-2 font-medium">Min Price</label>
                      <input
                        type="number"
                        placeholder="0"
                        value={priceRange[0]}
                    ...
                    <div>
                      <label className="block text-sm text-gray-400 mb-2 font-medium">Max Price</label>
                      <input
                        type="number"
                        placeholder="10000"
                        value={priceRange[1]}
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between text-sm text-gray-400 font-medium">
                      <span>₹0</span>
                      <span className="text-blue-400 font-bold">₹{priceRange[1]}</span>
                      <span>₹10000+</span>
                    </div>
                  </div>
                </div>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6">
              <div>
                ...
                <p className="text-gray-400 text-base lg:text-lg">
                  Showing <span className="text-blue-400 font-semibold">{filteredProducts.length}</span> of <span className="text-white font-semibold">{products?.products?.length || 0}</span> products
                  {activeFiltersCount > 0 && (
        ...
        {activeFiltersCount > 0 && (
          <div className="px-6 lg:px-8 py-4 bg-gray-800/30 border-b border-gray-700">
            <div className="flex items-center gap-3 flex-wrap">
              ...
              {category.map(cat => (
                <span key={cat} className="bg-purple-500/20 text-purple-300 px-3 py-1 rounded-full text-sm border border-purple-500/30">
                  {cat}
                </span>
              ))}
              {subCategory.map(subCat => (
                <span key={subCat} className="bg-green-500/20 text-green-300 px-3 py-1 rounded-full text-sm border border-green-500/30">
                  {subCat}
                </span>
              ))}
              {(priceRange[0] !== 0 || priceRange[1] !== 10000) && (
              ...
              {sortType !== 'relevant' && (
                <span className="bg-pink-500/20 text-pink-300 px-3 py-1 rounded-full text-sm border border-pink-500/30">
                  Sort: {sortType === 'low-high' ? 'Price ↑' : sortType === 'high-low' ? 'Price ↓' : 'Newest'}
                </span>
              )}
            </div>
          </div>
          ...
          {filteredProducts && filteredProducts.length > 0 ? (
            <div className={
              ...
              {filteredProducts.map((item, idx) => (
                <div key={item._id || item.id || idx} className="animate-in fade-in duration-300" style={{animationDelay: `${idx * 50}ms`}}>
                  <Card
                    name={item.name}
            ...
            <div className="text-center py-20 lg:py-32">
              <div className="max-w-md mx-auto">
                ...
                <h3 className="text-2xl lg:text-3xl font-bold text-white mb-4">
                  {activeFiltersCount > 0 ? 'No products match your filters' : 'No products available'}
                </h3>
