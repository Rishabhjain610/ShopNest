...
import { FaPlus, FaTimes, FaImage, FaEdit } from "react-icons/fa";
...
const Editlisting = () => {
  ...
  const fetchSingleProduct = async () => {
    try {
      ...
      const response = await axios.get(`${serverUrl}/api/product/get/${id}`, {
      ...
      <div className="md:ml-60 pt-24 md:pt-20 min-h-screen bg-black p-4 md:p-6">
        <div className="max-w-4xl mx-auto">
          <div className="bg-gray-900 shadow-2xl rounded-xl overflow-hidden border border-gray-800">
            ...
            <form className="p-6 space-y-8" onSubmit={handleUpdateProduct}>
